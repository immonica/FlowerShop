...
public class FlowershopBouquetsController {
    ...
    @FXML
    public ListView<Flower> FlowershopsList;
    @FXML
    public Text userBox;
    @FXML
    private Button Order;
    @FXML
    private Button BackToFlowershops;
    @FXML
    ...
    public void handleBackFloristsButton() throws Exception {
        ...
        control.initData(us);
        Stage stage1 = (Stage) BackToFlowershops.getScene().getWindow();
    ...
    public void listViewSelectedFlower(){
        selectedProd = FlowershopsList.getSelectionModel().getSelectedItem();
        updateGUI();
    }
    ...
    public void handleOrderAction() throws Exception {
        OrdersService.loadOrdersFromFile();
        if (FlowershopsList.getSelectionModel().getSelectedItem()!=null)
        {
            try {
